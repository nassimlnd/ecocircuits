    ...
    return (
        <>
            ...
            <div className="flex items-start">
                <aside
                    id="sidebar-mobile"
                    className="flex fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-16 h-full duration-75 border-r border-gray-200 lg:flex transition-width rounded-none dark:border-gray-700 w-64 hidden lg:block">
                    <Sidenav/>
                </aside>
