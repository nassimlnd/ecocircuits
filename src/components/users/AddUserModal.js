...
export default function AddUserModal({fetchUsers}) {
    ...
    return (
        <>
            ...
            <Button onClick={() => setOpen(true)}>Créer un utilisateur</Button>
                                                ...
                                                <form onSubmit={addUser}>
                                                    <div className="p-6">
                                                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                                            <div><label
                                                                ...
                                                                <div className="flex mt-1">
                                                                    <div className="relative w-full"><input
                                                                        ...
                                                                        placeholder="francois37" required={true}/></div>
                                                                </div>
                                                            </div>
                                                            <div><label
                                                                className="text-sm font-medium text-gray-900 dark:text-gray-300"
                                                            ...
                                                            <div><label
                                                                ...
                                                                <div className="flex mt-1">
                                                                    <div className="relative w-full md:space-y-2">
                                                                        <div className="flex">
                                                                            <Checkbox
                                                                                id="admin"
                                                                                name="admin"
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            type="submit"><span
                                                            className="flex items-center rounded-md text-sm px-3 py-2">Créer l'utilisateur</span>
                                                        </button>
                                                        <button
