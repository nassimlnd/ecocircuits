            ...
            >
                ...
                <div className="fixed inset-0 z-10 overflow-y-auto">
                    <div
                        ...
                        >
                            <Dialog.Panel
                                className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800s text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-xl">
                                    ...
                                    {!loading && !successAnimation && !errorAnimation ? (<div>
                                        <div
                                            ...
                                            <h3 className="text-xl font-medium text-gray-900 dark:text-white"><span
                                                className="sr-only">Supprimer l'utilisateur</span></h3>
                                        ...
                                        <div className="p-6 px-6 pb-6 pt-0">
                                            <div className="flex flex-col items-center gap-y-6 text-center">
                                                ...
                                                <p className="text-lg text-gray-500 dark:text-gray-300">
                                                    Êtes-vous sûr de vouloir supprimer l'utilisateur n°{id} ? Cette
                                                    action
                                                    est irréversible.
                                                </p>
                                                ...
                                                <div className="flex items-start justify-between rounded-t px-5 pt-5 px-3 pt-3 pb-0">
                                                    <div className="mb-4 mt-10 rounded-full border-4 border-red-600">
                                                        <svg
                                                             ...
                                                             viewBox="0 0 24 24" className="text-7xl text-red-600 fill-red-600"
